...
cleaned_data <- read_csv("../data/modeling_data.csv")
...
model_results <- read_csv("../data/heart_attack_model_summary.csv")
...
significant_vars <- read_csv("../data/significant_vars.csv")
...
simplified_data <- read_csv("../data/heart_attack_data_simplified.csv")
...
::: {#fig-pair-plot}
![A pairwise scatterplot of each of the variables in the simplified model](../results/eda_pairplot.png){width=100%}
:::
::: {#fig-corr-matrix}
![A correlation heatmap of each of the variables in the simplified model](../results/eda_corrplot.png){width=100%}
:::
...
vif_results <- read_csv("../data/heart_attack_vif.csv")
...
accuracy_data <- read_csv("../data/model_acc.csv")
...
# Read AUC results
auc_simplified <- read_csv("../data/simplified_model_auc.csv")
...
::: {#fig-corr-matrix}
![ROC curve](../results/simplified_model_roc.png){width=50%}
:::
...
# Read AUC results
auc_rf <- read_csv("../data/random_forest_auc.csv")
...
![Random Forest ROC](../results/random_forest_roc.png){width=50%}
:::
